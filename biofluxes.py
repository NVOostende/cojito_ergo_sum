...
class biofluxes():
	...
	def __init__(self,pyroms_grid,file_dia_roms):
		...
		self.fact_units = 1035 * 86400 * 6.625 * 12 #* 1000
	...
	def populate_sankey_dict(self):
		...
		self.dict_sankey['Zdet_btf'] = self.fact_units * ( self.compute_mean_of_2d_diag('prod_ndet_100_mdz') + self.compute_mean_of_2d_diag('prod_ndet_100_lgz') )
		...
		self.dict_sankey['pe-ratio'] = 0.
		self.dict_sankey['z-ratio'] = 0.
		self.dict_sankey['f-ratio'] = 0.
		#...
	...
	def plot_sankey(self):
		...
		ax = fig.add_subplot(1, 1, 1, xticks=[], yticks=[], title="Flow Diagram of N")

		Nfluxes = self.dict_sankey
		sankey = Sankey(ax=ax, scale=1./Nfluxes['total_DIN'], offset=0.1, head_angle=140,
                format='%.0f', unit='')
		#prior 0
		sankey.add(patchlabel='DIN', facecolor='lightgreen', rotation=180, trunklength=0.25,
		...
		#prior 1
		sankey.add(patchlabel='Psm N', facecolor='lightgreen', rotation=180, trunklength=0.4,
		...
		prior=0, connect=(1,0))
		#prior 2
		sankey.add(patchlabel='Zsm N', facecolor='lightblue', trunklength=0.4,
		...
		prior=1, connect=(3,0))
		#prior 3
		sankey.add(patchlabel='Pmd N', facecolor='lightgreen', rotation=180, trunklength=1.0,
		...
		prior=0, connect=(2,0))
		#prior 4
		sankey.add(patchlabel='Zmd N', facecolor='lightblue', trunklength=.6,
		...
		prior=2, connect=(3,1))
		#prior 5
		sankey.add(patchlabel='Plg N', facecolor='lightgreen', rotation=180, trunklength=1.85,
		...
		prior=0, connect=(3,0))
		#prior 6
		sankey.add(patchlabel='Zlg N', facecolor='lightblue', trunklength=1.,
...
bf1.create_mask_analytic(130,180,300,450)
